defmodule AtpClient.Isabelle.Session do
  ...
  The `:owner` field is a private `AtpClient.Isabelle.SessionOwner` pid that
  isolates the link to the Shared process from the caller; `close_session/1`
  stops it, which in turn shuts the Shared process down. Treat it as opaque.
  """
